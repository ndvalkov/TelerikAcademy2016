...
class TriangleSurface
{
    static void Main()
    {
        ...
        double result = Triangle.TriangleSurfaceCalculator.CalculateSurfaceByDegree(a, b, angle);
...
class Triangle : Shape
{
    ...
    public static class TriangleSurfaceCalculator
    {
        ...
        public static double CalculateSurfaceByDegree(double a, double b, double angleInDegrees)
        {
