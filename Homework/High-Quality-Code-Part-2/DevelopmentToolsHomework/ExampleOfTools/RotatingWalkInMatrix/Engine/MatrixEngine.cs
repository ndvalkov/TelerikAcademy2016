namespace RefactoringHomework.RotatingWalkInMatrix.Engine
{
    ...
    /// <summary>
    /// A class that is responsible for the execution of the matrix engine
    /// logic: matrix traversal, filling the cells with numbers and printing the
    /// result. 
    /// <remarks>Logging added</remarks>
    /// </summary>
    public class MatrixEngine : IEngine
    {
        ...
        private static readonly ILog Log = LogManager.GetLogger(typeof(MatrixEngine));
